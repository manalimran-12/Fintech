...
const AboutUs = () => {
    ...
    return (
        <Box sx={{ width: '100%', backgroundColor: '#272727', overflow: 'hidden', height: '115vh', display: 'flex', position: 'absolute', top: isSmScreen ? (isS8Screen ? '25%' : '18%') : (isMdScreen ? (isIpadProScreen ? '16%' : '22.7%') : '45%') }}>
