...
const AboutUs = () => {
    ...
    return (
        <Box sx={{ width: '100%', backgroundColor: '#272727', overflow: 'hidden', height: '115vh', display: 'flex', position: 'absolute', top: isSmScreen ? (isS8Screen ? '30%' : '25%') : (isMdScreen ? (isIpadProScreen ? '20%' : '20%') : '45%') }}>
