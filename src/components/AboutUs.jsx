    ...
    <Box sx={{ backgroundColor: '#272727', width: '100%' }}>
      ...
      <Box
        sx={{
          ...
          display: 'flex',
          alignItems: 'center',
          gap: isSmScreen ? '20px' : '100px',
          marginTop: isSmScreen ? '5px': '20px',
          marginBottom:  isSmScreen ? '5px': '20px',
        }}
      >
        <Image src="/foree-sahulat 1.png" alt='logof' width={isSmScreen ? 30 : 100} height={isSmScreen ? 10 : 50} />
        <Image src="/tawakal bazaar.png" alt='logot' width={isSmScreen ? 30 : 100} height={isSmScreen ? 10 : 50} />
        <Image src="/kistPay.png" alt='logok' width={isSmScreen ? 30 : 100} height={isSmScreen ? 10 : 50} />
        {!isSmScreen && (
          <>
            <Image src="/Abhi.png" alt='logoa' width={100} height={50} />
            <Image src="/creditBook.png" alt='logoc' width={100} height={50} />
            <Image src="/Fina.png" alt='logoF' width={100} height={50} />
          </>
        )}
        {isSmScreen && (
          <>
