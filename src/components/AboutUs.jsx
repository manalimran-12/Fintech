...
const AboutUs = () => {
    ...
    const isIpadProScreen = useMediaQuery("(min-width: 900px) and (max-width: 1025px)");
        ...
        <Box sx={{ width: '100%', backgroundColor: '#272727', overflow: 'hidden', height: '115vh', display: 'flex', position: 'absolute', top: isSmScreen ? (isS8Screen ? '4.7in' : '19%') : (isMdScreen ? (isIpadProScreen ? '20%' : '20%') : '45%') }}>
            ...
            <Button
                ...
                sx={{
                    ...
                    marginLeft: isSmScreen ? (isS8Screen ? '20px' : '20px') : (isMdScreen ? (isIpadProScreen ? '50px' : '50px') : '100px'),
                    marginRight: '110px',
