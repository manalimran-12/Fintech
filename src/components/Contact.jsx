...
const Contact = () => {
  ...
  const C_heading=heading({color:'#D8B150',left:'0px' ,fontSize:'18px',
  ...
  return (
    <Box sx={{background:'#313131',height:'auto', borderRadius:'6px',
    width:isSmScreen?'80%':isMdScreen?'80%':'65%', padding:'20px 10px 20px 10px',
    position:'absolute',top:isSmScreen?'4.5in':isMdScreen?'6.75in':isLgScreen?'6in':'6in',left:'10%',
    display:'flex',flexDirection:'column',gap:'12px',alignItems:'center'}}>
      ...
      <Typography textAlign='center' sx={C_text}>Submit your details,
       ...
       <Box sx={{display:'flex', flexWrap:'wrap', gap:'12px',flexDirection:'row',
